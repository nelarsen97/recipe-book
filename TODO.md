...
- [ ] CI builds it automatically: every merge to `main` reruns the "Android APK" workflow and
      refreshes the `ci-latest` release
- [ ] Open https://github.com/nelarsen97/recipe-book/releases/download/ci-latest/app-release.apk
      on your phone and install the APK (allow "install from unknown sources" if Android asks)
